...
library BeaconProofs {
    ...
    function validatorChunks() internal pure returns (bytes32[8] memory) {
        ...
        chunks[0] = 0x8d7c2b324f41a1d395fc265d42c6e1293b38c33a674244cae9ac67d68367036d; // bls key hash
    ...
    function eip4788ValidatorInclusionProof() internal pure returns (BeaconChainHelperLib.InclusionProof memory) {
        return BeaconChainHelperLib.InclusionProof({
